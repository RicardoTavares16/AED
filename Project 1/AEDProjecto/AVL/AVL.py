...
class AVLTree():
    ...
    def insert(self, key,nick,list):
        ...
        if tree == None:
            ...
            self.node.left.insert(key,nick,list)

        elif key > tree.key:
            self.node.right.insert(key,nick,list)
    ...
    def printTree(self):
        if (self.node != None):
            ...
            print(self.node.key + " " + self.node.nick + " " + ' '.join(self.node.years))
    ...
    def getNode(self,key):
        ...
        if no != None:
            if no.key == key:
                ...
                return no.left.getNode(key)
            elif key > no.key:
                return no.right.getNode(key)
